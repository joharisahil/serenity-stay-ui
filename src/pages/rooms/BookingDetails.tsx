...
//     <Button size="sm" variant="outline" onClick={addAdvance}>
//       + Add Advance
//     </Button>
//   </CardHeader>
...
//           value={adv.amount}
//           onChange={(e) =>
//             updateAdvance(idx, "amount", Number(e.target.value))
//           }
//         />
...
//           value={adv.mode}
//           onChange={(e) => updateAdvance(idx, "mode", e.target.value)}
//         >
...
//           type="date"
//           value={adv.date}
//           onChange={(e) => updateAdvance(idx, "date", e.target.value)}
//         />

//         <Input
//           placeholder="Note"
//           value={adv.note || ""}
//           onChange={(e) => updateAdvance(idx, "note", e.target.value)}
//         />
